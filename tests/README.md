...
| `scalar-types.asdf` | scalars whose YAML spelling decides their type: quoted `"42"`/`"1.0"`/`"true"`/`"0x10"`/`"1e3"`/`"no"`, plain `1.0`/`-2.0` floats, plain `y`/`n` as axis names, and an inline array that omits `shape` |
