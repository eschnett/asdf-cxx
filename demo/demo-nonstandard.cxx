...
int main(int argc, char **argv) {
  ...
  // A structured (record) datatype with a sub-array field, stored inline.
  // This is standard conformant, but Python asdf 5.3 with numpy 2 cannot read
  // inline structured arrays, so it lives here rather than in demo.asdf.
